...
test("event should be sent and received in intended format", () => {
    let theGameState = new ChessGameState(null); // doesn't need data, just needs functions
...
test("random numbers should be int and in specified range", () => {
    ...
    for (let i=0; i<100; i++) { // lots of random numbers increases chance of going 
        // out of expected range if possible
        let value = theGameState.getRandomInt(0,10);
