...
describe("Promotion Scene Display Test", () => {
	...
	test("chess pieces should be interactive an enabled", () => {
		...
		const queenPromotion = scene.children.getChildren().find((child) => child.texture === "queen");
		...
		const knightPromotion = scene.children.getChildren().find((child) => child.texture === "knight");
		...
		const bishopPromotion = scene.children.getChildren().find((child) => child.texture === "bishop");
		...
		const rookPromotion = scene.children.getChildren().find((child) => child.texture === "rook");
