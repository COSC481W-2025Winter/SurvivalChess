...
describe("Start Scene", () => {
    ...
    test("text objects should be created", () => {
        ...
        const titleText = scene.children
            .getChildren()
            .find((child) => child.text === "Survival Chess");
    ...
    test("start button should be created and interactive", () => {
        ...
        const startButton = scene.children
            .getChildren()
            .find((child) => child.text === "Start Game");
    ...
    test("settings button should be created and interactive", () => {
        ...
        const settingsButton = scene.children
            .getChildren()
            .find((child) => child.text === "Settings");
    ...
    test("rules button should be created and interactive", () => {
        ...
        const rulesButton = scene.children
            .getChildren()
            .find((child) => child.text === "See Rules");
